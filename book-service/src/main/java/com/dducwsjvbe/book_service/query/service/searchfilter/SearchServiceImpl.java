...
public class SearchServiceImpl implements SearchService {
    ...
    @Override
    public List<Book> findByFilter(Pageable pageable, String[] book, Boolean isReady) {
    ...
    public Predicate toBookPredicate(Root<Book> root, CriteriaBuilder builder, SpecSearchCriteria criteria) {
